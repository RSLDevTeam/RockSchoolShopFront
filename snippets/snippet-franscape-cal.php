...
<div class="franscape-booking-widget max-w-[1300px] bg-white text-rock-gray-900 shadow-lg p-8 mx-auto gap-8 mb-[5em]" data-aos="zoom-in">
	...
	<?php
	if ($franscape_id) {
    $api_url = 'https://api.uk.prod.franscape.services/v1/public/classes?page=1&count=50&filter=' . urlencode(json_encode(['franchisee_ids' => [(int) $franscape_id]]));
	        ...
	        <div class="franscape-cal-item bg-rockschool-grey p-4 flex flex-col <?php echo $hide_class; ?>" data-aos="zoom-in">
	        	...
	        	<div class="">
		            ...
		            <div class="title-and-time">
			            ...
			            <p class="text-sm text-gray-600 no-margin"><?php echo esc_html($schedule['day_name'] . 's at ' . $schedule['time_12']); ?></p>
			        </div>
		        </div>
	            ...
	            <div class="grid grid-cols-4 gap-2 text-center text-sm mb-[1em] mt-[1em]">
	                ...
	                <div>
	                    <div class="font-semibold"><?php echo $duration; ?></div>
	                    <div class="text-xs">hour<?php echo $duration > 1 ? 's' : ''; ?></div>
	                </div>
	            </div>
    ...
    <?php
	    ...
	    echo '<div id="franscape_cal"><p>No franchisee ID found.</p></div>';
	}
	?>
