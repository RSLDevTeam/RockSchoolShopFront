...
function rockschool_setup() {
	/*
		...
		* If you're building a theme based on rockschool, use a find and replace
		* to change 'rockschool' to the name of your theme in all the template files.
		*/
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'rockschool' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'rockschool_custom_background_args',
			array(
